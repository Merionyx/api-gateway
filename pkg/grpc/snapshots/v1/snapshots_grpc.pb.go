...
const (
	SnapshotsService_UpdateSnapshot_FullMethodName    = "/merionyx.gateway.snapshots.v1.SnapshotsService/UpdateSnapshot"
	SnapshotsService_GetSnapshotStatus_FullMethodName = "/merionyx.gateway.snapshots.v1.SnapshotsService/GetSnapshotStatus"
)
...
func RegisterSnapshotsServiceServer(s grpc.ServiceRegistrar, srv SnapshotsServiceServer) {
	// If the following call panics, it indicates UnimplementedSnapshotsServiceServer was
...
var SnapshotsService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "merionyx.gateway.snapshots.v1.SnapshotsService",
	...
	Metadata: "merionyx/gateway/snapshots/v1/snapshots.proto",
}
