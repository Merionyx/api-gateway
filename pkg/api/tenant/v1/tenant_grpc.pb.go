...
const (
	TenantService_CreateTenant_FullMethodName    = "/api.tenant.v1.TenantService/CreateTenant"
	TenantService_GetTenant_FullMethodName       = "/api.tenant.v1.TenantService/GetTenant"
	TenantService_GetTenantByName_FullMethodName = "/api.tenant.v1.TenantService/GetTenantByName"
	TenantService_GetTenants_FullMethodName      = "/api.tenant.v1.TenantService/GetTenants"
	TenantService_UpdateTenant_FullMethodName    = "/api.tenant.v1.TenantService/UpdateTenant"
	TenantService_DeleteTenant_FullMethodName    = "/api.tenant.v1.TenantService/DeleteTenant"
)
...
func (c *tenantServiceClient) GetTenantByName(ctx context.Context, in *GetTenantByNameRequest, opts ...grpc.CallOption) (*GetTenantByNameResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetTenantByNameResponse)
	err := c.cc.Invoke(ctx, TenantService_GetTenantByName_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTenantServiceServer) GetTenantByName(context.Context, *GetTenantByNameRequest) (*GetTenantByNameResponse, error) {
...
func _TenantService_GetTenantByName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetTenantByNameRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TenantServiceServer).GetTenantByName(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TenantService_GetTenantByName_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TenantServiceServer).GetTenantByName(ctx, req.(*GetTenantByNameRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TenantService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _TenantService_GetTenantByName_Handler,
		},
		{
	...
	Metadata: "api/proto/v1/tenant.proto",
}
