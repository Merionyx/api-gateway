...
type EnvironmentsUseCase interface {
	SetDependencies(environmentRepo EnvironmentRepository, inMemory InMemoryEnvironmentsRepository, schemasUseCase SchemasUseCase, xdsSnapshotManager *xdscache.SnapshotManager, xdsBuilder XDSBuilder)
